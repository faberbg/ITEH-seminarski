...
<body>
        ...
        <div class="row align-items-center">
          <div class="col-lg-5 ml-auto">
           <h3 class="text-center">Unos detalja termina</h3>
            ...
            <br>
            <br>
           <input  style="width: 100% color: white;" type="submit" lass="submit" align="center" type="submit" class="form-control btn-primary" name="izmenaListica" value="Add quota">
            </form>
  ...
  <script src="js/main.js"></script>
   ...
   <script>
  $(':input[name=izmenaListica]').click(function() {
                // process the form
                $("form").submit(function(event) {
                    // get the form data
                    var formData = {
                        'idListica' : $(':input[name=idListica]').val(),
                        'kvota'   : $(':input[name=quota]').val()
                    };
